...
class Bitbot:
    ...
    # --  BitBot or BitBotHumanoid initialization
    def init(self, YL, YR, RL, RR, load_calibration, Buzzer, LA = -1, RA = -1):
    ...
    # --  BitBotHumanoid initialization (depreciated)
    def initHUMANOID(self, YL, YR, RL, RR, LA, RA, load_calibration, Buzzer):
        self.init(YL, YR, RL, RR, load_calibration, Buzzer, LA, RA)
    ...
    def getRestState(self):
        return self._isBitBotResting

    def setRestState(self, state):
        self._isBitBotResting = state

    # -- Predetermined Motion Sequences

    # -- BitBot movement: HOME BitBot at rest position
    def home(self):
    ...
    # -- BitBot gait: Walking  (forward or backward)
    # --  Parameters:
    # --    * steps:  Number of steps
    # --    * T : Period
    ...
    # -- BitBot gait: Turning (left or right)
    # --  Parameters:
    # --   * Steps: Number of steps
    # --   * T: Period
    # --   * Dir: Direction: LEFT / RIGHT
    def turn(self, steps, T, dir):
        # -- Same coordination than for walking (see BitBot.walk)
    ...
    def bend(self, steps, T, dir):
        ...
        if dir == RIGHT:
            bend1[2] = 180 - 50
            bend1[3] = 180 - 80  # -- Not 65. BitBot is unbalanced
            bend2[2] = 180 - 105
            bend2[3] = 180 - 60
    ...
    # -- BitBot movement: swinging side to side
    # --  Parameters:
    # --     steps: Number of steps
    # --     T : Period
    ...
    # -- BitBot movement: swinging side to side without touching the floor with the heel
    # --  Parameters:
    # --     steps: Number of steps
    # --     T : Period
    # --     h : Amount of swing (from 0 to 50 aprox)
    ...
    # -- BitBot gait: Ascending & turn (Jitter while up&down)
    # --  Parameters:
    # --    steps: Number of bends
    # --    T: Period of one bend
    ...
    # -- BitBot gait: Moonwalker. BitBot moves like Michael Jackson
    # --  Parameters:
    # --    Steps: Number of steps
    # --    T: Period
    ...
    def moonwalker(self, steps, T, h, dir):
        ...
        # -- The two BitBot's feet are equivalent to a minimal configuration. It is known
        # -- that 2 servos can move like a worm if they are 120 degrees out of phase
        # -- In the example of BitBot, two feet are mirrored so that we have:
    ...
    # -- BitBot gait: Crusaito. A mixture between moonwalker and walk
    # --   Parameters:
    # --     steps: Number of steps
    # --     T: Period
    ...
    # -- BitBot movement: Hands up
    def handsup(self):
        if self._servo_totals > 4:
            homes = [90, 90, 90, 90, 20, 160]
            self._moveServos(1000, homes)

    # -- BitBot movement: Wave , either left or right
    ...
    # -- BitBot bend tone from one tone to another
    # -- Parameters:
    ...
    def playGesture(self, gesture):
        if gesture == gestures.BITBOTHAPPY:
            self._tone(notes.E5, 50, 30)
        ...
        elif gesture == gestures.BITBOTSUPERHAPPY:
            self.putMouth(mouths.HAPPYOPEN)
            ...
            self.home()
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTSAD:
            ...
            utime.sleep_ms(300)
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTSLEEPING:
            ...
            self.home()
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTFART:
            ...
            utime.sleep_ms(500)
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTCONFUSED:
            ...
            self.home()
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTLOVE:
            ...
            self.sing(songs.HAPPYSHORT)
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTANGRY:
            ...
            self.home()
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTFRETFUL:
            self.putMouth(mouths.ANGRY)
            self.bendTones(notes.A5, notes.D6, 1.02, 20, 4)
            self.bendTones(notes.A5, notes.E5, 1.02, 20, 4)
            utime.sleep_ms(300)
            ...
            self.home()
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTMAGIC:
            for i in range(4):
            ...
            utime.sleep_ms(300)
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTWAVE:
            for i in range(2):
                noteW = 500
            ...
            utime.sleep_ms(100)
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTVICTORY:
            ...
            self.clearMouth()
            self.putMouth(mouths.HAPPYOPEN)
        elif gesture == gestures.BITBOTFAIL:
            self.putMouth(mouths.SADOPEN)
